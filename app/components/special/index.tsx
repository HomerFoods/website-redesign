...
const Special = () => {
    return (
      <div className="mt-10 flex items-center mb-3 justify-center">
        <div className="mr-[48px] w-1/2">
          <div className="mb-[52px]">
            <h2 className="font-bold font-gilroybold mb-[7px] text-[50px] leading-[60px]">
